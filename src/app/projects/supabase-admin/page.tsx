...
const NotificationDropdown = ({ open, onClose }: { open: boolean; onClose: () => void }) => {
  ...
  return (
    <>
      ...
      <div className="fixed left-4 right-4 top-14 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-80 bg-[#0d1117] border border-[#1e2d3d] rounded-xl shadow-2xl shadow-black/50 z-50 animate-fade-in-up overflow-hidden">
