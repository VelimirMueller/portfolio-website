...
export const Button = ({
  ...
  const baseStyle = "inline-flex items-center justify-center font-mono text-xs md:text-sm font-bold tracking-tight transition-all duration-200 rounded-full px-6 py-3 border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 active:scale-[0.97]";
